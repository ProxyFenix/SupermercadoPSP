...
public class Manipulahilos implements Runnable {
	...
	/**
	 * Vale, esto es simple.. 15/02: Pedimos el login, comprobarEmpleado también.
		...
		try {
			...
			do {
				if (fEntr.startsWith("COBRO")) {
					...
					/*
					 * arrayString[0] equivaldría a "COBRO" arrayString[1] equivaldría al numero de
					 * producto tras el primer ";" arrayString[2] equivaldría a la cantidad tras el
					 * segundo ";"
					 */
	...
	/**
	 * En este metodo añadimos la compra segun la cantidad y el producto, casando
